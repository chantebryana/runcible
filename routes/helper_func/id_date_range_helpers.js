...
get_first_and_last_cycle_id = function get_first_and_last_cycle_id(callback) {
...
find_next_previous_cycle = function find_next_previous_cycle(current_cycle_id, callback) {
	get_cycle_id_by_date(function (cycle_id_array){
